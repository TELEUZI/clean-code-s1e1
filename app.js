...
var taskInput = document.querySelector(".input-form__input"); //Add a new task.
var addButton = document.querySelector(".input-form__accept"); //first button
...
var createNewTaskElement = function(taskString) {
    ...
    editInput.classList.add("task__input_hide");
    ...
    deleteButtonImg.classList.add('button__inner');
...
var editTask = function() {
    ...
    if (containsClass) {
        ...
        editInput.classList.add("task__input_hide");
        editInput.classList.remove("task__input_show");
        label.innerText = editInput.value;
        editBtn.innerText = "Edit";
    } else {

        editInput.classList.add("task__input_show");
        editInput.classList.remove("task__input_hide");
        editInput.value = label.innerText;
        editBtn.innerText = "Save";
    }
    label.classList.toggle('task__description_hide');
...
var taskCompleted = function() {
    ...
    var listItem = this.parentNode;
    var label = listItem.querySelector("label");
    label.classList.add('task__description_completed');
...
var taskIncomplete = function() {
    ...
    var listItem = this.parentNode;
    var label = listItem.querySelector("label");
    label.classList.remove('task__description_completed');
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem, taskCompleted);
}
